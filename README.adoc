...
| Refactoring
| 2024-3
|  Added enum for ISO-639-1 codes. Made syntax forward compabitble with records. So, getters like `getPart1()`) are dropped in favor of `part1()`. `LanguageCode` itself is now an interface. This may be backported to 1.2 for javax compatibility. 

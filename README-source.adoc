...
[source,java]
----
include::src/test/java/org/meeuw/i18n/languages/test/ExamplesTest.java[tag=import]
...
include::src/test/java/org/meeuw/i18n/languages/test/ExamplesTest.java[tag=dutch, indent=0]
----
...
include::src/test/java/org/meeuw/i18n/languages/test/ExamplesTest.java[tag=import]
...
include::src/test/java/org/meeuw/i18n/languages/test/ExamplesTest.java[tag=krim, indent=0]
----
...
include::src/test/java/org/meeuw/i18n/languages/test/ExamplesTest.java[tag=import]
...
include::src/test/java/org/meeuw/i18n/languages/test/ExamplesTest.java[tag=fallback, indent=0]
----
...
[source, java]
----
include::src/test/java/org/meeuw/i18n/languages/test/ExamplesTest.java[tag=dse, indent=0]

----

== Live demo

A live demo can be found at link:https://mihxil.github.io/i18n-iso-639[github pages]. Using cheerpj to run java in the browser.
...
| 4.2
| LanguageCode#getDefault, some cleaning in dependencies
| 2026-01
|

| 4.x
| Mostly updates of the code tables from sil.org
| 2026-

| 4.6
|  Moved away from checkerframework. Implementing Constable.
|
